...
import com.turingoal.bts.dispatch.manager.MaintenanceWorkItemManager;
 ...
 * 新增任务
 */
@Route(path = TgArouterPaths.TASK_ADD)
public class SchedulingTaskAddActivity extends TgBaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_scheduling_task_add;
    }

    @Override
    protected void initialized() {
        initToolbar(R.id.tv_title_text, R.id.iv_black, "新建任务");
        ...
        List<String> maintenanceTaskTitleList = new ArrayList<>();
