 ...
 * 通用单独播放界面
 */
public class TgVideoPlayerActivity extends TgBaseActivity {
    ...
    public static void actionStart(Context context, String path) {
        Intent intent = new Intent(context, TgVideoPlayerActivity.class);
    ...
    protected int getLayoutId() {
        return R.layout.common_activity_video_player;
    }
    ...
    protected void initialized() {
        ...
        videoView.setVideoURI(Uri.parse(mPath)); // 网络视频
        ...
        videoView.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mediaPlayer, int what, int extra) {
                if (!isFinishing()) { // 播放失败
                    Toast.makeText(TgVideoPlayerActivity.this, "播放失败", Toast.LENGTH_SHORT).show();
                }
                finish();
                return false;
            }
